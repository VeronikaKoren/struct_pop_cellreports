% compute cross-correlogram for all neurons in the session using trials from both
% conditions
% cross-correlation (ccg_raw - ccg_trial_invariant)
...
nshuffle=20;                                                                  % number of trial order permutations for computing the trial invariant ccg (to be subtracted from the cross-correlation function)
